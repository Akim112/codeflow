...
namespace CodeFlow.Api.Migrations
{
    ...
    [Migration("20260517091950_AddUserMoralChoices")]
    partial class AddUserMoralChoices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeFlow.Api.Models.SubmissionJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeFlow.Api.Models.UserMoralChoice", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime>("ChosenAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("UserMoralChoices");
                });

            modelBuilder.Entity("CodeFlow.Api.Models.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
