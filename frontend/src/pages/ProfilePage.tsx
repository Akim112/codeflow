...
const ProfilePage = () => {
  ...
  const completedCount = JSON.parse(localStorage.getItem('completedLessons') || '[]').length;
  ...
  return (
    <Container size="lg" py="xl">
      ...
      <Group justify="space-between" mb="xl">
        <Button variant="subtle" component={Link} to="/courses" leftSection="←">
          К МИССИЯМ
        </Button>
        <Group>
            ...
            <SimpleGrid cols={2} spacing="lg">
              ...
              <Paper p="md" bg="#1a1a1a" radius="md">
                <Group gap="xs">
                  ...
                  <div>
                    <Text size="xl" fw={700}>{unlockedIds.length}</Text>
              ...
              return (
                <Paper 
                  ...
                  style={{ 
                    ...
                    transition: 'all 0.3s',
                    borderColor: isUnlocked ? `var(--mantine-color-${rarityColors[ach.rarity]}-6)` : undefined
                  }}
                >
                  <Group wrap="nowrap">
                    ...
                    <div style={{ flex: 1 }}>
                      <Group gap="xs" mb={4}>
                        ...
                        <Badge size="xs" color={rarityColors[ach.rarity]} variant="dot">
